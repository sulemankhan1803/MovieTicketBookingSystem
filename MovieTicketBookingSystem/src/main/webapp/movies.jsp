            ...
            <tbody>
                <%
                    ...
                    try {
                        ...
                        String url = "jdbc:mysql://localhost:3306/filmygeek1";
                        String username = "root";
                        String password = "001122";
                            ...
                            <div class="modal-body">
                                ...
                                <form action="<%=request.getContextPath()%>/editMovie" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="editTheaterId<%=movieId%>" name="editTheaterId" value="<%=theaterId%>" required disabled>
                                    </div>
